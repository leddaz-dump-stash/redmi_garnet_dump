...
agmcap $recfilename  -r 96000 -b 16 -c 1 -T 7 -p 1024 -n 4 -D 100 -d 101 -i CODEC_DMA-LPAIF_RXTX-TX-4 &

ret=$?
if [ $ret -ne 0 ]; then
    echo "agmcap done, return $ret"
fi
...
echo "start playing"
agmplay $playfilename -r 96000 -D 100 -d 100 -i TDM-LPAIF_VA-RX-PRIMARY-VIRT-0  -dkv 0xA2000100
